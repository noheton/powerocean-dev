...
SENSOR_DESCRIPTIONS: dict[str, SensorEntityDescription] = {
    ...
    "stopChargingSoc": SensorEntityDescription(
        key="stopChargingSoc",
        translation_key="pp_stop_charging_soc",
        native_unit_of_measurement=PERCENTAGE,
        device_class=SensorDeviceClass.BATTERY,
        state_class=SensorStateClass.MEASUREMENT,
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    "evPlugAndPlay": SensorEntityDescription(
        key="evPlugAndPlay",
        translation_key="pp_ev_plug_and_play",
        icon="mdi:ev-plug-type2",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    "expectChargingEnergy": SensorEntityDescription(
        key="expectChargingEnergy",
        translation_key="pp_expect_charging_energy",
        device_class=SensorDeviceClass.ENERGY,
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        state_class=SensorStateClass.MEASUREMENT,
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    "evDetectPhase": SensorEntityDescription(
        key="evDetectPhase",
        translation_key="pp_ev_detect_phase",
        icon="mdi:sine-wave",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    "evExeMode": SensorEntityDescription(
        key="evExeMode",
        translation_key="pp_ev_exe_mode",
    ...
    # ── Connectivity (EMS_CHANGE_REPORT) ─────────────────────────────────────
    "iot4gSta": SensorEntityDescription(
        key="iot4gSta",
        translation_key="iot4g_sta",
        icon="mdi:signal-4g",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    "iot4gErr": SensorEntityDescription(
        key="iot4gErr",
        translation_key="iot4g_err",
        icon="mdi:signal-off",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    "wifiStaStat": SensorEntityDescription(
        key="wifiStaStat",
        translation_key="wifi_sta_stat",
        icon="mdi:wifi",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    "ethWanStat": SensorEntityDescription(
        key="ethWanStat",
        translation_key="eth_wan_stat",
        icon="mdi:ethernet",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    # ── Grid / inverter diagnostics (EMS_HEARTBEAT) ───────────────────────────
    "pcsAcFreq": SensorEntityDescription(
        key="pcsAcFreq",
        translation_key="pcs_ac_freq",
        native_unit_of_measurement="Hz",
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        icon="mdi:sine-wave",
    ),
    "emsNtcTempMax": SensorEntityDescription(
        key="emsNtcTempMax",
        translation_key="ems_ntc_temp_max",
        device_class=SensorDeviceClass.TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        state_class=SensorStateClass.MEASUREMENT,
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    "pcsLeakAmp": SensorEntityDescription(
        key="pcsLeakAmp",
        translation_key="pcs_leak_amp",
        device_class=SensorDeviceClass.CURRENT,
        native_unit_of_measurement=UnitOfElectricCurrent.MILLIAMPERE,
        state_class=SensorStateClass.MEASUREMENT,
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    # ── Per-phase inverter measurements (EMS_HEARTBEAT) ───────────────────────
    "pcsAPhase_vol": SensorEntityDescription(
        key="pcsAPhase_vol",
        translation_key="pcs_a_phase_vol",
        device_class=SensorDeviceClass.VOLTAGE,
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
    ),
    "pcsAPhase_amp": SensorEntityDescription(
        key="pcsAPhase_amp",
        translation_key="pcs_a_phase_amp",
        device_class=SensorDeviceClass.CURRENT,
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
    ),
    "pcsAPhase_actPwr": SensorEntityDescription(
        key="pcsAPhase_actPwr",
        translation_key="pcs_a_phase_act_pwr",
        device_class=SensorDeviceClass.POWER,
        native_unit_of_measurement=UnitOfPower.WATT,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ),
    "pcsBPhase_vol": SensorEntityDescription(
        key="pcsBPhase_vol",
        translation_key="pcs_b_phase_vol",
        device_class=SensorDeviceClass.VOLTAGE,
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
    ),
    "pcsBPhase_amp": SensorEntityDescription(
        key="pcsBPhase_amp",
        translation_key="pcs_b_phase_amp",
        device_class=SensorDeviceClass.CURRENT,
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
    ),
    "pcsBPhase_actPwr": SensorEntityDescription(
        key="pcsBPhase_actPwr",
        translation_key="pcs_b_phase_act_pwr",
        device_class=SensorDeviceClass.POWER,
        native_unit_of_measurement=UnitOfPower.WATT,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ),
    "pcsCPhase_vol": SensorEntityDescription(
        key="pcsCPhase_vol",
        translation_key="pcs_c_phase_vol",
        device_class=SensorDeviceClass.VOLTAGE,
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
    ),
    "pcsCPhase_amp": SensorEntityDescription(
        key="pcsCPhase_amp",
        translation_key="pcs_c_phase_amp",
        device_class=SensorDeviceClass.CURRENT,
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
    ),
    "pcsCPhase_actPwr": SensorEntityDescription(
        key="pcsCPhase_actPwr",
        translation_key="pcs_c_phase_act_pwr",
        device_class=SensorDeviceClass.POWER,
        native_unit_of_measurement=UnitOfPower.WATT,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ),
    # ── Per-string MPPT detail (EMS_HEARTBEAT) ────────────────────────────────
    "mpptPv1_vol": SensorEntityDescription(
        key="mpptPv1_vol",
        translation_key="mppt_pv1_vol",
        device_class=SensorDeviceClass.VOLTAGE,
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
    ),
    "mpptPv1_amp": SensorEntityDescription(
        key="mpptPv1_amp",
        translation_key="mppt_pv1_amp",
        device_class=SensorDeviceClass.CURRENT,
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
    ),
    "mpptPv1_pwr": SensorEntityDescription(
        key="mpptPv1_pwr",
        translation_key="mppt_pv1_pwr",
        device_class=SensorDeviceClass.POWER,
        native_unit_of_measurement=UnitOfPower.WATT,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ),
    "mpptPv2_vol": SensorEntityDescription(
        key="mpptPv2_vol",
        translation_key="mppt_pv2_vol",
        device_class=SensorDeviceClass.VOLTAGE,
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
    ),
    "mpptPv2_amp": SensorEntityDescription(
        key="mpptPv2_amp",
        translation_key="mppt_pv2_amp",
        device_class=SensorDeviceClass.CURRENT,
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
    ),
    "mpptPv2_pwr": SensorEntityDescription(
        key="mpptPv2_pwr",
        translation_key="mppt_pv2_pwr",
        device_class=SensorDeviceClass.POWER,
        native_unit_of_measurement=UnitOfPower.WATT,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
